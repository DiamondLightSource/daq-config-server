...
FILE_TO_CONVERTER_MAP: dict[str, Callable[[str], ConfigModel | dict[str, Any]]] = {  # type: ignore
    "/tests/test_data/test_good_lut.txt": UndulatorEnergyGapLookupTable.from_parse_lut_rows,  # For system tests # noqa: E501
    ...
    "/dls_sw/i03/software/daq_configuration/lookup/DetDistToBeamXYConverter.txt": DetectorXYLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i04/software/daq_configuration/lookup/DetDistToBeamXYConverter.txt": DetectorXYLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i04-1/software/daq_configuration/lookup/DetDistToBeamXYConverter.txt": DetectorXYLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i19-1/software/daq_configuration/lookup/DetDistToBeamXYConverter.txt": DetectorXYLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i23/software/daq_configuration/lookup/DetDistToBeamXYConverter.txt": DetectorXYLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i24/software/daq_configuration/lookup/DetDistToBeamXYConverter.txt": DetectorXYLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i03/software/daq_configuration/lookup/BeamLineEnergy_DCM_Pitch_converter.txt": BeamlinePitchLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i03/software/daq_configuration/lookup/BeamLineEnergy_DCM_Roll_converter.txt": BeamlineRollLookupTable.from_parse_lut_rows,  # noqa: E501
    "/dls_sw/i03/software/daq_configuration/lookup/BeamLine_Undulator_toGap.txt": UndulatorEnergyGapLookupTable.from_parse_lut_rows,  # noqa: E501
